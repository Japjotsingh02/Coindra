...
const ChartCard = memo(({ title, option, children, forceKey, titleSiblingComponent }: ChartCardProps) => {
  return (
    <div
      className={cn(
        'bg-gradient-to-r from-surface-border/50 to-surface-ring/50',
        'p-3 sm:p-4 2xl:p-5 rounded-xl shadow-lg border',
        'border-surface-ring hover:border-brand/30 transition-all',
        'duration-300'
      )}
    >
