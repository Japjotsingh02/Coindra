...
import { ModernCalendarSkeleton, ModernWelcomeSkeleton } from '@/components/ui/modern-skeleton';
...
export default function Home() {
  ...
  if (!symbol) {
    return (
      <main className="min-h-screen px-2 px-3 2xl:px-4 py-4 2xl:py-5" aria-label="Coindra (Crypto Market Explorer)">
  ...
  return (
    <main className="min-h-screen px-3 2xl:px-4 py-4 2xl:py-5" aria-label="Coindra (Crypto Market Explorer)">
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-4 2xl:gap-5">
        <ResponsiveSidebar />
        <div className="flex-1 overflow-auto min-h-0 flex flex-col gap-4 2xl:gap-5" aria-label="calendar-heatmap">
